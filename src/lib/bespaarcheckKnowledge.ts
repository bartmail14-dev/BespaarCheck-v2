...
export const kennisbank: KnowledgeItem[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Na de berekening kan de bezoeker vrijblijvend een aanvraag per e-mail klaarzetten.',
    ],
    anchor: '#calculator',
  },
  {
...
const kennisbankEn: KnowledgeItem[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'After the calculation, the visitor can prepare a non-binding request by email.',
    ],
    anchor: '#calculator',
  },
  {
